...
public class DamParser {
	...
	private Stmt statement() {
		...
		//if (match(STR)) return typecastStatement();
		//if (match(BOOL)) return typecastStatement();
		//if (match(DOUBLE)) return typecastStatement();
	...
	private Expr primary() {
		...
		if (match(BOOL, DOUBLE, STR)) {
			Token type = previous();
			consume(LEFT_PAREN, "Expect '(' after type.");
			Expr value = expression();
			consume(RIGHT_PAREN, "Expect ')' after expression.");
